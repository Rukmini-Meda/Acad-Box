...
export const ACTION_TYPES = {
    ...
    SET_CREATE_INSTANT_MEETING_ERRORS: "createInstantMeetingErrors",
    UNSET_CREATE_INSTANT_MEETING_ERRORS: "unsetCreateInstantMeetingErrors",
    SET_PLAN_MEETING_ERRORS: "setPlanMeetingErrors",
    UNSET_PLAN_MEETING_ERRORS: "unsetPlanMeetingErrors",
    SET_CURRENT_MEETING: "setCurrentMeeting"
}
...
export const TYPES = {
    ...
    SET_CREATE_INSTANT_MEETING_ERRORS: SLICES.ERRORS + "/" + ACTION_TYPES.SET_CREATE_INSTANT_MEETING_ERRORS,
    UNSET_CREATE_INSTANT_MEETING_ERRORS: SLICES.ERRORS + "/" + ACTION_TYPES.UNSET_CREATE_INSTANT_MEETING_ERRORS,
    SET_PLAN_MEETING_ERRORS: SLICES.ERRORS + "/" + ACTION_TYPES.SET_PLAN_MEETING_ERRORS,
    UNSET_PLAN_MEETING_ERRORS: SLICES.ERRORS + "/" + ACTION_TYPES.UNSET_PLAN_MEETING_ERRORS,
    SET_CURRENT_MEETING: SLICES.MEETING + "/" + ACTION_TYPES.SET_CURRENT_MEETING
}